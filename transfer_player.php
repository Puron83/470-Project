...
<tr>
<th>Remove</th>
<td><a href="remove.php?id=<?php echo $row1['player_id']; ?>">Remove</a></td>
</tr>
...
?>
      ...
      <div id="content">
        ...
        <h2>Add Players From This List</h2>
  ...
  <table border = "1">
        ...
        while ($row = mysqli_fetch_assoc($query_run)) 
          { 
            ...
            <tr>
              ...
              <td><a href="stat.php?id=<?php echo $row['player_id'] ?>">Stat</a></td>
    ...
    <div id="footer">
      <p>Copyright &copy; Gias | Sudipta | Hameem </p>
    </div>
